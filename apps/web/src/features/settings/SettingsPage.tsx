...
export const SETTINGS_SECTIONS = [
  ...
  },
  {
    ...
    label: 'Canvas',
    icon: MousePointer2,
    description: 'Grid, snapping and input.',
  ...
  },
  {
    ...
    icon: Brush,
    description: 'Starting styles for new shapes.',
  ...
  },
  {
    ...
    icon: Keyboard,
    description: 'Customize editor shortcuts.',
  ...
  },
  {
    ...
    label: 'Notifications',
    icon: Bell,
    description: 'What we notify you about.',
  ...
  },
  {
    ...
    component: WorkspaceSettingsLinks,
  },
] as const;
    ...
    <div className="flex min-h-dvh flex-col">
      ...
      <div className="mx-auto flex w-full max-w-5xl flex-1 flex-col gap-6 px-4 py-6 sm:px-6 md:flex-row md:gap-10 md:py-10">
        <nav aria-label="Settings" className="md:w-56 md:shrink-0">
          <h1 className="mb-3 hidden px-2 text-lg font-semibold tracking-tight md:block">
            Settings
          </h1>
        ...
        <main
          id="main-content"
          className="min-w-0 flex-1 pb-[env(safe-area-inset-bottom)]"
          tabIndex={-1}
        >
          <div className="mb-6">
