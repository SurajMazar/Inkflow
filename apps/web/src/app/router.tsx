...
const InviteAcceptPage = lazyPage(
  () => import('@/features/auth/pages/InviteAcceptPage'),
  'InviteAcceptPage',
);
const ShareLinkPage = lazyPage(
  () => import('@/features/share-link/ShareLinkPage'),
  'ShareLinkPage',
);
...
const FavoritesView = lazyPage(
  () => import('@/features/dashboard/views/FavoritesView'),
  'FavoritesView',
);
const SharedView = lazyPage(() => import('@/features/dashboard/views/SharedView'), 'SharedView');
const TemplatesView = lazyPage(
  () => import('@/features/dashboard/views/TemplatesView'),
  'TemplatesView',
);
...
const WorkspaceSettingsPage = lazyPage(
  () => import('@/features/workspaces/WorkspaceSettingsPage'),
